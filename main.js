...
const BANNED_WORDS = [
  // Violence
  'kill', 'murder', 'stab', 'shoot', 'attack', 'bomb', 'explode',
  'die', 'death', 'slaughter', 'massacre', 'execute', 'assassinate',
  // Hate
  'hate', 'racist', 'sexist', 'faggot', 'nigger', 'retard',
  // Harassment
  'idiot', 'moron', 'stupid', 'dumbass', 'loser', 'scum', 'trash',
  'worthless', 'ugly', 'fat', 'freak', 'psycho',
  // Explicit (abbreviated for academic use)
  'fuck', 'shit', 'bitch', 'asshole', 'bastard', 'crap', 'damn',
  'hell', 'piss', 'cunt', 'whore', 'slut',
  // Threats
  'threaten', 'hurt', 'harm', 'destroy', 'ruin', 'punish',
];
